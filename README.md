...
## 18. Herstellungsroute für keramische Bauteile

| Schritt Teilprozessen                     | Verfahren                                  |
| ----------------------------------------- | ------------------------------------------ |
| 1. Natürliche und synthethische Rohstoffe | 0                                          |
| 2. Masseaufbereitung                      | Mahlen, Mischen, Granulieren               |
| 3. Formgebung                             | Extrudieren, Spritzgießen, Schlichergießen |
| 4. Brandvorbereitung                      | Trocknen, Verglühen, Glasieren             |
| 5. Sintern                                | Sintern, Heißpressen                       |
| 6. Endbearbeiten                          | Schneiden, Bohren, Schleifen               |
| 7. Endprüfung                             | 0                                          |

## 19. Selektiv Laser Sintern

### Verfahrensablauf

1. Schichtinfomation wird über Laserscanner in das Puver übertragen
2. Pulverpartikel werden über Laser versintert
3. Schaffung von zusammenhängenden Schicht und Verbund mit der darunter liegenden Schicht
4. Baubereich senkt sich ab
5. Rolle überträgt Pulver aus den Vorratsbehältern
6. Nächste Schicht wird belichtet

### Einsatz

1. Herstellung von Prototypen und funktionalen Werkstücken
2. Nur für Einzelteile oder Kleinserien geeignet

### Werkstoffe für das SLS

1. Thermoplaste: Polyamid(PA), Polystyrol (PS), Polycarbonat (PC), Polyetheretherketon (PEEK)
2. Formsand, Keramiken nur mit thermoplastischem Binder möglich

# 叁. Umformen

## 20. Fertigungsverfahren von Umformen
...
## 22. Haupteinflussgrößen auf die Genauigkeit bei der Massivumformung

| Einflssgrößen    | Beispiel                                     |
| ---------------- | -------------------------------------------- |
| 1. Werkzeug      | Herstellunggenauigkeit, Verschließ, Federung |
| 2. Werkstoff     | physikanische- chemische Eigenschaften       |
| 3. Maschine      | Arbeitsvermögen, Auffederung, Führung        |
| 4. Halbzeug      | Maßgenauigkeit, Zuschnitt                    |
| 5. Verfahren     | Kaltumformen, Warmumformen                   |
| 6. Arbeitsablauf | Ausgangsform, Zwischenform, Endform          |

## 23. Schnittkraft verringern

1. geschliffene Stempel
2. abgesetzte Stempel

## 24. Umformmaschinen

| Funktionsprinzipien | Einsatzgebiet            |
| ------------------- | ------------------------ |
| 1. Energiegebunden  | Massivumformung          |
| 2. Weggebunden      | Blenchumformung          |
| 3. Kraftgebunden    | Massiv- und Blenchumform |

## 25. Kengrößen für Umformmaschinen

| Kengrößen                      | Beispiel                               |
| ------------------------------ | -------------------------------------- |
| 1. Kraftkenngrößen             | maximale Presskraft, Auswerferkraft    |
| 2. Geometrische Kenngrößen     | Hub, Auswerferweg                      |
| 3. Zeitkenngrößen              | Dauerhubzahl, Berührzeit               |
| 4. Genauigkeitskenngrößen      | Rechtwinkligkeit der Stößelbewegung    |
| 5. Energiekenngrößen           | Arbeitsvermögen, Federarbeit           |
| 6. Bedingungen am Arbeitsplatz | Gesamtgewicht, Tragfähigkeit von Boden |



# 肆. Trennen

## 26. Trennen und Spanen

### 1. Trennen

Trennen ist Festigen durch Ändern der Form eines festen Köperns, wobei der Zusammenhalt örtlich zerstört, dass heißt, im Sinne des Zusammenhalts im Ganzen vermindert wird.

### 2. Spanen

Spanen ist Trennen , bei dem von einm Werkstück mit Hilfe der Schneiden eines Werkzeuge, Werstoffschichten in Form von Spänen machanisch abgetrennt werden, zur Änderung der Werkstückform und Werkstückoberfläche.

### 3. Merkmale von Spanen

+ mechanische Wirkprinzip
+ Späne entstehen
+ Schneidengeometrie, Lage und Anzahl sind bestimmt oder unbestimmt
+ Form entsteht durch Abbilden der Werkzeuggeometrie, gesteuerte Relativbewegung oder Kombination beider Varianten.

## 27. Trennen in 6 Gruppen
...
## 28. Ablauf von Spanen

1. Durchdringung von Werkzeug und Werkstück
2. Elastische und plastische Verformung
3. Fließen von Werkstoffe
4. Ausbildung von Span
5. Ablaufen von Span über die Spanfläche von Schneidkeil

## 29. Voraussetzungen von Spanen

1. Härte von Werkzeugwerkstoff höher als Härte von Werkstückstoff
2. Überschreitung von minimalan Eindringtife
...
## 31. Einfluss auf Spanarten

1. Werkstückstoff(Umpormbarkeit)
2. geometrische und kinematische Parameter

## 32. Schneidstoffarten

1. Werkzeugstahl
2. Hartmetall
3. Keramik
4. Kubische Bornitrid
5. Diamant

## 33. Anforderungen an moderne Schneidstoffe
...
## 34. Hauptkomponenten von modernen Drehmaschine

1. Werkzeugsystem
2. Werkzeugträger
3. Werkstückantrieb
4. Werkstückspannung
5. Werkstückabstützung
6. Vorschubantriebe

## 35. Maschinenseitige Möglichkeiten zur Steigerung der Produktivität von Zerspanprozessen

1. Mehrstück und Mehrschnittbearbeitung durch mehrspindlige Vielschlittendrehautomaten
2. Komplettbearbeitung in einer Aufspannung
3. Steigerung von Automatisierungsgrad

## 36. Hochgeschwindigkeitsbearbeitung

Hochgeschwindigkeitsbearbeitung bezeichnet spanende Bearbeitung von Werkstoffen ab einer 10fach höheren Schnittgeschwindigkeit gegenüber herkömmlichen Werten

## 37. Vor-Nachteile von HSC

### Vorteile 

1. Reduzierung von Zerspankräfte
2. Bessere Oberflächengüten
3. Reduzierung von Haupt- und Durchlaufzeiten

### Nachteile

1. hohe Anforderungen an die Maschinen und Baugruppen
2. hohe Anforderungen an Sicherheitsvorrichtungen
3. Erhöhung der Nebenzeiten aufgrung reduzierter Standzeit des Werkzeugs



## 38. Fräsen in 6 Gruppen
...
## 39. Unterschied zwischen Profil- und Formfräsen

1. Beim Profilfräsen wird ein Werkzeug mit werstïckgebundener Form verwendet. Beispiele sind das Fräsen von Nuten, Radien, Zahnflanken oder Führungsbahnen.
2. Beim Formfräsen wird die gewünschte Werkstückgeometrie durch eine gesteuerte Relativbewegung zwischen Werkzeug und Werkstück erzeugt. Dazu werden mittlerweile größtenteils CNC-Fräsmaschienen eingesetzt.

## 40. Unterschieden 3 Achs und 5 Achsfräsen

1. Beim 3 Achs Fräsen gibt es nur 3 translatorische Achsen, beim 5 Achs Fräsen gibt es zusätzlich 2 rotatorische Achsen
2. 3 Achs Fräsen kann nur die Position der Fräserspitze gesteuert Werden, aber 5 Achs Fräsen kann auch die Fräseracherichtung gesteuert werden.

# 伍. Schleifen

## 41. Gefügeaufbau von Schleifscheibe

| Bestandenteile          | Aufgabe                                                      |
| ----------------------- | ------------------------------------------------------------ |
| Korn                    | Das Korn dient als Schneide                                  |
| Kornabstand             | 0                                                            |
| Bindungsbrücke(Bindung) | Die Bindung hat die Aufgabe, die Schleifkörner zu halten. Nach Erreichen eines bestimmten Verschleißzustandes soll die Bindung die Schleifkörner während des Schleifvorganges freigeben, so dass das nachfolgende, scharfe Korn zum Eingriff kommen kann. |
| Brückenlänge            | 0                                                            |
| Pore                    | Pore beinflussen die Performance der Schleifscheibe          |

## 42. Schleifscheibenhärten 

die Schleifscheibenhärten ist definiert als deren Widerstand gegen das Ausbrechen einzelner Körner aus dem Bindungsverband.

## 43. Schleifsmittel

| 砂轮材料                                | 被磨工件             |
| --------------------------------------- | -------------------- |
| 1. Eletrokorund (Al2O3)                 | gehärtete Stähle     |
| 2. Siliciumcarbrid (SiC)                | Grauguss, NE-Metalle |
| 3. Kubisch kristallines Bornitrid (CBN) | Schnellarbeitsstähle |
| 4. Diamant                              | Keramik, Glas, Beton |

## 44. Bindungsarten

| Bindungsarten               | Merkmal                                                      |
| --------------------------- | ------------------------------------------------------------ |
| 1. Kunstharzbindung         | Geringe Bearbeitungskräfte <br>Hohe Oberflächengüten         |
| 2. Keramikbindung           | Schleifprozesse im Selbstschärfbereich<br>Derzeit hohe Anschaffungskosten |
| 3. Gesinterte Metallbindung | Hohe Bearbeitungskräfte , Hohe Zeitspanungsvolumina möglich <br>Lange Profilstandzeit |

## 45. Kornverschleiß

1. Druckerweichung 
2. Absplitterung von Kristallgruppen
3. teilweiser Kornausbruch
4. vollkommener Kornausbruch

## 46. Konditionieren

Alle Prozesse, die der Schaffung oder der Regeneration der Schleifkörpern dienen, können unter dem Begriff Konditionieren zusammengefasst werden.

## 47. Ziele von Konditionieren

1. Abrichten: 

- Profilieren: Makrostruktur, Herstellen von Rundlauf Scheibenprofil, Veränderung von Korn und Bindung beabsichtigt.
- Schärfen: Mikrostruktur, Erzeugen der Topographie, Zurücksetzen der Bindung beabsichtigt.

2. Reinigen: 

* Mikrostruktur, Beseitigen von Spänen aus dem Spänen aus dem Spanraum, Keine Veränderung der Schleifscheibe beabsicht.

## 48. Planschleifen, Pendel- und Tiefschleifen

1. Beim Pendelschleifen erfolgt das Abtennen des Matrials währen mehrerer Überschliffe mit geringen Einzelzustellungen und verhältnismäßig großen Vorschubgeschwindigkeiten.
...
2. Beim Tiefschleifen wird die Werkstückform mit großen Zustellung, oft sogar in einem Überschliff und mit herabgesetzten Vorschubgeschwindigkeiten aus dem vollen Material geschliffen.
...
1. Schleifaktive Wirkstoffe
2. Deckbindemittel
3. Grundbindemittel
4. Unterlage
5. Schleifmittel(Korn)
6. Verbingdungsstelle

## 50. Honen

Honen ist Spanen mit geometrisch unbestimmten Schneiden, wobei die vielschneidigen Werkzeuge eine aus 2 Komponenten bestehende Schnittbewegung ausführen, von denen mindestens eine Komponente hin- und hergehend ist, so dass die bearbeitete Oberfläche sich definiert überkreuzende Spuren aufweist.

## 51. Läppen

| Vorteile                                | Nachteile                               |
| --------------------------------------- | --------------------------------------- |
| 1. Keine gerichteten Bearbeitungsspuren | 1. Nur einfache Geometrien bearbeitbar  |
| 2. Geringe Bearbeitungstemperaturen     | 2. Hoher Kornverbrauch                  |
| 3. Geringe Bearbeitungskräft            | 3. Vergleichsweise geringe Abtrennraten |



# 陆. Abtragen

## 52. Abtragen Definiert

Abtragen ist Fertigen durch Abtrennen von Stoffteilchen von einen festen Körper auf nichtmechanischem Wege. Das Abtragen bezieht sich sowohl auf das Entfernen von Werkstoffschichten als auch auf das Abtrennen von Werkstückteilen.

## 53. Unterteilen Abtragen

| Wirkungsprinzip              | Verfahrensbeispiel                                           |
| ---------------------------- | ------------------------------------------------------------ |
| 1. Chemisches Abtragen       | Ätzabtragen,<br>Thermisch-chemisches Abtragen, <br>Thermisch-chemisches Entgraten |
| 2. Thermisches Abtragen      | Thermisches Abtragen durch Strahl                            |
| 3. Elektochemisches Abtragen | Elektrochemisches Formabtragen                               |



## 54. Funkenerosionsanlage

1. Vorschubregelung
2. Eielektrikum(Öl)
3. Pumpen und Filter aggregat
4. Impulsgenerator
5. Werkzeug
6. Werkstück

## 55. Wiekprinzip von Funkenerosion

1. Phase: Anlegen einer Gleichspannung, die an Stelle mit der geringsten Spaltweite ein elektrisches Feld zur Folge hat.
2. Die Bewegung der elektrischen Ladungsträger und ihre Vervielfachung bewirkt einen raschen Anstieg der lokalen Temperatur des Dielektikums , es bildet sich eine Gasblase.
3. Elektrischer Durchschlag, es fließt ein von außen begrenzter elektrischer Entladestrom, die Spannung bricht von der Leerlaufspannung auf die Entladespannung zusammen, hier Wandlung elektrischer Energie in Wärmeenergie durch die kinetische Aufschmelzen der Werkstückoberflächen.
4. Durch Abschalten des Entladestroms bricht der Entladekanal zusammen, der einen Unterdruck und eine schnelle Herabsetzung der siedetemperatur zur Folge hat, Elektrodenmaterial wird herausgeschleudert oder verdampft, nur in der vierten Phase findet ein Materialabtrag statt, Materialmenge hängt von der Stromdichte und der Entladedauer ab.

## 56. Vor-Nachteile von Funkenerosion

| Vorteile                                                     | Nachteile                                                    |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| Bearbeitung schwer zerspanbarer Werkstoffe unabhängig von Werkstückhärte | hohe Fertigungskosten durch hohen Zeitaufwand und Kosten für Wasseraufbereitung und Elektroden. |
| sehr hohe Maßgenauigkeit                                     |                                                              |
| Herstellung variabler Oberflächenstrukturen                  |                                                              |
| keine Gratbildung                                            |                                                              |
...
## 57. Merkmale für Senkerosion

1. Einsatz einer Formelektrode 
2. Formelektrode ist das Negativ der zu erzeugenden Kontur im Werkstück
3. Konturerzeugung erfolgt durch Einsenken der Formelektrode in das Werkstück
4. kinematisches Prinzip des “Abformens”
5. Formgenauigkeit hängt vom Arbeitsspalt und vom Verschleißverhalten der Elektrode ab



## 58. Verfahrensvarianten von Laserstrahlschneiden

1. Laser-Brennschneiden
...
2. Laser-Schmelzschneiden

```
Der Werkstoff wird durch den Laserstrahl aufgeschmozen und mit Hilfe eines reaktionsträgen Gases aus der Schnittfuge geblasen.
Anwendung: Hochlegierte Stähle, Michteisenmetalle.
```



3. Laser-Sublimierschneiden

```
Der Werkstoff wird auf Sublimationstemperatur erhitzt und mit Hilfe eines reaktionsträgen Gases aus der Schnittfuge geblasen.
Anwendung: Holz, Papier, Keramik, Kunststoffe.
```



## 59. Vorteile von Laser

1. Hohe Leistungsdichte durch hervorragende Fokussierbarkeit
2. Alle Materialein bearbeitbar
3. Das Werkzeug Laserstrahl ist flexibel einsatzbar und arbeitet berührungslos
...
| Teilen                   | Anwendungsbeispiel                |
| ------------------------ | --------------------------------- |
| 1. Zusammensetzen        | Kugeln in Kugellager Einlegen     |
| 2. Füllen                | Bremsflüssigkeit in Bremszylinder |
| 3. An- und Einpressen    | Schraubenverbingdung              |
| 4. Fügen durch Urformen  | Draht mit Kunststoff              |
| 5. Fügen durch Umformen  | Nieten im Flugzeugbau             |
| 6. Fügen durch Schweißen | Lichtbogenschweißen               |
| 7. Fügen durch Löten     | Hartlöten Leichtmetalle           |
| 8. Kleben                | Elektronikbauteile                |
| 9. Textiles              | Weben                             |
...
Fügen ist das auf Dauer angelegte Verbinden oder sonstige Zusammenbringen von zwei oder mehr Werkstücken geometrische bestimmter Form oder von eben solchen Werkstücken mit formlosem Stoff. Dabei wird jeweils der Zusammenhalt örtlich geschaffen und im Ganzen vermehrt.
...
1. Formschluss
   ...
   Formschluss ist einSchluss zwischen zwei sich berührenden Wirkflächen fester Körper senkrecht zu den Berührungsflächen.
...
2. Kraftschluss
   ...
   Kraftschluss ist ein Schluss, der eine Kraft sowohl über Wirkraume als auch über Wirkflächenpaarungen überträgt. Beim Kraftschluss werden die Teile an den Trennstellen bis zur Berührung zusammengefürt, so dass kein Spiel mehr vorhanden ist. Er verformt jedes Teil, das ihn überträgt, mehr oder weniger stark.
...
3. Stoffschluss
   ...
   Stoffschluss ist ein durch molekulare Kräfte entstehender Schluss zwischen Molekülen eines abgegrentzten Wirkraumes, der diese so zusammenhält, dass sie in der Gesamtheit einen festen Körper ergeben. Die Relativbewegung der verbundenen Teile ist in allen Richtung an den Verbindungsflächen gesperrt. 
...
## 63. Schweißen definieren

Schweißen ist das Fügen von Metallen oder Kunststoffen unter Anwendung von Wärme, Druck oder von beidem, und zwar mit oder ohne Zusatzwerkstoff mit gleichem oder nahezu gleichem Schmelzbreich.



## 64. Wärmequellen

1. Feuer (Schmiedefeuer, Gasbrenner)
2. Elektrische (Lichtbogen, Wirbelstrom, Induktion, Elektrische Widerstand)
3. Laser
4. Reibung
5. Exotherme chemische Reaktionen

## 65. Verschiedene Schweißverfahren

1. Gasschelzschweißen
...
## 66. Widerstandspressschweißen

die Metall verbindung erfolgt durch Erwärmen der Berührungsflächen der Werkstücke mit Hilfe des elektrischen Stroms und durch anschließendes Zusamendrücken.

## 67. Kleben Definieren

Kleben ist Fügen unter Verwendung eines Klebstoffes, das heißt eines nichtmetallischen Werkstoffes, der Fügeteile durch Flächenhaftung und innere Festigkeit(Adhäsion und Kohäsion) verbinden kann.

## 68. Adhäsion und Kohäsion

1. Adhäsion : Der Zusammenhalt zweier Matrialien im Kontakt zueinander.
2. Kohäsion : Eigenschaft eines Materials, die dessen Zusammenhalt bewirkt und seinen Zerfall verhindert.



# 捌. Beschichten

## 69. Einsatzgebiete von Beschichten

| Einsatzgebiete                    | Anwendung              |
| --------------------------------- | ---------------------- |
| 1. Korrosionsschutz Schichten     | Gastur binenschaufel   |
| 2. Verschleißschutz Schichten     | Umform werkzeuge       |
| 3. Dekorative Schichten           | Türbeschläge           |
| 4. Optische Funktionsschichten    | Kunststoff Brillenglas |
| 5. Magnetische Funktionsschichten | Kupfer                 |
| 6. Elektrische Funktionsschichten | Kontaktestellen        |



## 70. Aufbau von Werkstoffoberflächen

1. Verunreinigen (Fett, Öl, Wachs, Ruß)
2. Adsorptionsschicht
3. Oxidschicht
4. verformte Schicht
5. Grundwerkstoff
...
## 71. Vorbehandlungsmöglikeit

1. Entfetten
2. Aufrauhen
3. elektrisch leitfähig machen



## 72. Verschleißmechanismen

1. Abrasion
2. Adhäsion
3. Tribochemische Reaktion
4. Oberflächenverrüttung
5. Tribophysikalische Vorgänge



## 73. Mechanismen von Werkstoffschädigung bei Abrasion

1. Mikropflügen : Plastische Verformung des Grundwerkstoffs
2. Mikrospanen : Span wird aus Grundwerkstoff geschnitten
3. Mikroermüden : Nerformung über plastischen Zustand hinaus
4. Mikrobrechen : Schichtteile brechen aus oder platzen ab



## 74. Haftungstypen

1. Mechanischer Übergang: 

   > Haftung der Schicht durch reine mechanische Verklammerung.
   >
   > ---

2. Monoschicht Übergang:

   > Übergang erfolgt innerhalb einer oder weniger Atomschichten. Haftung erfolgt durch Van-der-Waals-Kräfte.
   >
   > ---

3. Verbindungs Übergang:

   > Übergang zwischen Substrat und Schicht ergolgt durch chemische Bindung.
   >
   > -------------

4. Diffusions Übergang:

   > kontinuierlischer Übergang der chmischen Zusammensetzung. Diffusion von Atomen aus den Substrat in die Schicht und umgekehrt.
   >
   > ---

5. Pseudodiffusions Übergang:

   > durch hohe Energie dringen nicht löslich Teilchen in tiefere Atomlagen des Substrates.
   >
   > ---



## 75. Prozessablauf beim PVD-Beschichten

1. Dampferzeugung.
2. Dampftransport von der Teilchen quelle zum Substrat.
3. Adsorption der Teilchen, Schicht -bildung und -wachstum auf dem Substrat.

## 76. PVD varianten

| Verfahrensvarianten | Dampferzeugungsquelle |
| ------------------- | --------------------- |
| 1. Bedampfen        | Heizung, Lichtbogen   |
| 2. Sputtern         | Plasma                |
| 3. Ionenplattieren  | Ionenstrahlquelle     |



## 77. Vor-Nachteil von Thermischen Beschichten

| Vorteile                                        | Nachteile                                             |
| ----------------------------------------------- | ----------------------------------------------------- |
| freie Wahl Schicht und Grundwerkstoff           | Hafteng und Porigkeit der Schicht begrenzen Anwendung |
| unabhängig von Geometrie und Größe der Bauteile | starker Spritzverlust                                 |
...
## 78. Gruppen von Wärmebehandeln

1. Glühen 退火
2. Härten
3. Isothermisches Umwandeln
4. Anlassen (Auslagern) 回火
5. Vergüten 调质处理
6. Tiefkühlen
7. Thermo-chemisches Behandeln
8. Aushärten 时效硬化



## 79. Wärmebehandeln Definieren

Ein Werkstück wird ganz oder teilweise Temperatur-Zeit-Folgen und gegebenenfalls zusätzlich anderen physikalischen und chemischen Einwirkungen ausgesetzt , um ihm Eigenschaften zu verleihen, die es für seine Weiterverarbeitung oder Verwendung geeignet machen.



## 80. Wärmebehandlungsverfahren für Stahlwerkstoffe

| Wärmebehandlungsverfahren   | Temperaturbereiche                          |
| --------------------------- | ------------------------------------------- |
| 1. Anlassen                 | 100~600°C                                   |
| 2. Rekristallisationsglühen | 400~600°C                                   |
| 3. Nitrierhärten            | um 500°C                                    |
| 4. Weichglühen              | 600~800°C = um Ac1                          |
| 5. Normalglühen             | 700~900°C = knapp oberhalb von Ac3 bzw. Ac1 |
| 6. Erwärmen zum Härten      | 700~1300°C                                  |
| 7. Hochgühen                | 800~1100°C                                  |
| 8. Diffusionsglühen         | 1000~1300°C                                 |
| 9. Warmumformen             | 500~1400°C                                  |
...
Ziel ist es, bei vorgegebener Festigkeit ein Maximum an Zähigkeit im Stahl zu entwickeln. Dies wird durch eine kombinierte Wärmebehandlung aus Härten und Anlassen erreicht.

## 83. Einsatzhärten 

Ziel ist es, eine hohe Härte durch Anreicherung der Randzone mit Kohlenstoff und anschließendem Härten (gegebenenfalls Anlassen, Weichglühen) zu erzeugen.



## 84. Unterscheidung zwischen Härten und Einsatzhärten

Einsatzhärten ist also ein Randschichthärten mit vorausgegangener Anreicherung der Oberfläche mit Kohlenstoff.



## 85. Nitrieren

Ziel ist die Oberfächenhärtung durch Anreicherung der Randzone mit Stickstoff.



## 86. Thermochemische Wärmebehandlungsverfahren
